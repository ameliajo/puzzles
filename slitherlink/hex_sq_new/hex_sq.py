...
class HexSqBoard(Board):
    ...
    def plot(self,show=True):
        ...
        for tile in self.tiles:
            ...
            plt.text(tile.approx_x-10,tile.approx_y,str(tile.tally),ha='center', va='center')
            #plt.text(tile.approx_x+10,tile.approx_y,str(tile.preliminary_tally),ha='center', va='center')
        if show:
            plt.show()
