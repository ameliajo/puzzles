...
def solvable(ambiguous_tile_ids,solution_ids,dirname='./output_files' ):
    edges_list,tiles_list = read_info(dirname)
...
if __name__=="__main__":
    ...
    num_ambiguous_tiles,num_starting_edges = 1,0 # base = 5, divisions = 3
