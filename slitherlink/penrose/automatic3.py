...
num_puzzles_to_make = 100
starting_tiles = random.sample(tiles_list,num_puzzles_to_make)
num_ambiguous_tiles,num_starting_edges = 26, len(edges) # base = 5, divisions = 2
...
mkdir('base4_files/'+dirname)


for i,starting_tile in enumerate(starting_tiles):
    subdir = 'base4_files/'+dirname+'/'+str(i+1)
    print(subdir)
    mkdir(subdir)
