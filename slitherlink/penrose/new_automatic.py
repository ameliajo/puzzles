...
num_ambiguous_tiles,num_starting_edges = 35, 4#len(edges) # base = 5, divisions = 2
...
for i,starting_tile in enumerate(starting_tiles):
    ...
    while not adequate:
        ...
        tiles_to_make_ambiguous = random.sample(b.tiles,num_ambiguous_tiles)
