...
#
    ...
    num_ambiguous_tiles,num_starting_edges = 55,0 # base = 5, divisions = 3
    ...
    for i in range(30):
        num_certain_edges = len(certain_edges)
        print(i)
        ...
        print('# Gained: ',len(certain_edges)-num_certain_edges)
        plot_temp(b,certain_edges)
